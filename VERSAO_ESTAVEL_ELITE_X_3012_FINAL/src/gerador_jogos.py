...
def gerar_previsao_concurso_alvo(df: pd.DataFrame, concurso_alvo: int) -> dict:
    ...
    if concurso_alvo <= ultimo_concurso:
    ...
    justificativa = (
        f"Previsao calculada para o concurso alvo {concurso_alvo}, imediatamente posterior ao "
        f"ultimo concurso carregado ({ultimo_concurso}). O ranking pondera frequencia geral, "
